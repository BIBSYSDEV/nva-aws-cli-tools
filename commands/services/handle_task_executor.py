...
class HandleTaskExecutorService:
    def __init__(self, profile, folder):
        ...
        self.switcher = {
            ...
            "move_top_to_additional_and_promote_additional": lambda task: self.move_top_to_additional_and_promote_additional(task),
            "move_top_to_additional_and_create_new_top": lambda task: self.move_top_to_additional_and_create_new_top(task),
